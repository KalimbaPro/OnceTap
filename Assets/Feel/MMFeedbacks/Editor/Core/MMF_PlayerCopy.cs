...
namespace MoreMountains.Feedbacks
{
	...
	static class MMF_PlayerCopy
	{
		...
		{
			foreach (MMF_Player player in MonoBehaviour.FindObjectsOfType<MMF_Player>().Where(p => p.KeepPlayModeChanges))
			{
		...
		{
			foreach (MMF_Player player in MonoBehaviour.FindObjectsOfType<MMF_Player>().Where(MMF_PlayerCopy.RuntimeChanges.ContainsKey))
			{
